...
d0 = read_excel("C:/Users/kboura01/OneDrive - University of Cyprus/AgStat/meta-analysis/Threshold_database_June2023_yield2edited_Sept26.xlsx")
View(d0)
...
d01=d0[,c("SOURCE","trt_functional","replicates","yield2","yield2_SE")]
...
d01$yield2=as.numeric(d01$yield2)
d01$yield2_SE=as.numeric(d01$yield2_SE)

d01=d01[-which(is.na(d01$yield2)),] # we exclude the rows that do not provide an effect size
...
dvth=data.frame(SOURCE=NA, trt_functional=NA, replicates=NA, yield2=NA, yield2_SE=NA)
dvst=data.frame(SOURCE=NA, trt_functional=NA, replicates=NA, yield2=NA, yield2_SE=NA)
dvc=data.frame(SOURCE=NA, trt_functional=NA, replicates=NA, yield2=NA, yield2_SE=NA)
...
lnRRm01=lnRRm01[-c(16,20)]
vlnRRm01=vlnRRm01[-c(16,20)]
...
lnRRm02=lnRRm02[-c(17,22)]
vlnRRm02=vlnRRm02[-c(17,22)]
...
funnel(A01, main="Funnel plot standard/control for yield2")
...
funnel(A02, main="Funnel plot threshold/control for yield2")
...
funnel(A12, main="Funnel plot threshold/standard for yield2")
...
write.table(Re, "C:/Users/kboura01/OneDrive - University of Cyprus/AgStat/meta-analysis/r-codes for metanalysis - final/re-yield2.txt", row.names=F)

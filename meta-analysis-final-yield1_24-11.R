...
d01=d0[,c("SOURCE","trt_functional","replicates","yield1","yield1_SE")]
...
d01$yield1=as.numeric(d01$yield1)
d01$yield1_SE=as.numeric(d01$yield1_SE)

d01=d01[-which(is.na(d01$yield1)),] # we exclude the rows that do not provide an effect size
...
dvth=data.frame(SOURCE=NA, trt_functional=NA, replicates=NA, yield1=NA, yield1_SE=NA)
dvst=data.frame(SOURCE=NA, trt_functional=NA, replicates=NA, yield1=NA, yield1_SE=NA)
dvc=data.frame(SOURCE=NA, trt_functional=NA, replicates=NA, yield1=NA, yield1_SE=NA)
...
lnRRm01=lnRRm01[-c(34)]
vlnRRm01=vlnRRm01[-c(34)]
...
lnRRm02=lnRRm02[-c(36)]
vlnRRm02=vlnRRm02[-c(36)]
...
funnel(A01, main="Funnel plot standard/control for yield1")
...
funnel(A02, main="Funnel plot threshold/control for yield1")
...
funnel(A12, main="Funnel plot threshold/standard for yield1")
...
write.table(Re, "C:/Users/kboura01/OneDrive - University of Cyprus/AgStat/meta-analysis/r-codes for metanalysis - final/re-yield1.txt", row.names=F)
...
mtext("yield1",3, line=-3, cex=3, oute=TRUE)
